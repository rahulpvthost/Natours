...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFodWxwdnQiLCJhIjoiY210em44a3JsMGMzNDJ3czRrbGJ5ZDAzdCJ9.VDCNjJ_FX5qJFKG6OioRPA';
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alert.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Something went wrong');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
